...
function HomePage () {
  ...
  return (
    <div style={{ backgroundImage: 'url("bgcrop.png")' }} className=" text-white font-arial  w-100% h-screen bg-cover bg-center bg-no-repeat bg-black" >
      {/* Hero Section */}
      ...
      <div className="grid grid-cols-2 mx-[100px]">
        ...
        <div className="relative ml-8">
          ...
          <div className="pl-10">
            <p className="text-4xl font-bold text-white mb-6">Empowering Innovators Through Technology Challenges</p>
            <p className="text-gray-300 mb-10">
              <span className="font-bold">KESEDZ FEST</span> is a national-scale technology competition platform that brings together aspiring developers, designers, analysts, and innovators to showcase their talents, solve real-world problems, and elevate their skills through various tech-based challenges.
            </p>
        ...
        <div className="relative space-y-8 ml-8">
          <div className="flex">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">TRANSFORMING<br />TECH INNOVATION</h2>
          ...
          <div className="flex">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">ACCELERATING DIGITAL<br />SKILL MASTERY</h2>
              <p className="text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="bg-black rounded-[22px] h-full p-8 flex flex-col">
              <div className="mb-6">
                <div className="h-12 w-12 flex items-center justify-center">
                  <img src="low_density.png" alt="Code Icon" className="h-8 w-8 object-contain" />
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-pink-500 via-purple-500 to-purple-700 p-0.5 rounded-3xl">
            <div className="bg-black rounded-[22px] h-full p-8 flex flex-col">
              <div className="mb-6">
                <div className="h-12 w-12 flex items-center justify-center">
                  <img src="manufacturing.png" alt="Web Icon" className="h-8 w-8 object-contain" />
                </div>
              </div>

              <h3 className="text-3xl font-bold text-white mb-5">Web Development</h3>
              <p className="text-gray-400 mb-8">
                Showcase your coding expertise by creating innovative, responsive, and functional website applications.
              </p>
              ...
              <div className="bg-black rounded-[22px] h-full p-8 flex flex-col">
                <div className="mb-6">
                  <div className="h-12 w-12 flex items-center justify-center_">
                    <img src="linked_services.png" alt="Design Icon" className="h-8 w-8 object-contain" />
                  </div>
                </div>

                <h3 className="text-3xl font-bold text-white mb-5">UI/UX Design</h3>
                <p className="text-gray-400 mb-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Join us in celebrating the spirit of innovation and creativity as we bring together 
              bright minds to tackle real-world challenges. Our competitions are designed to 
              inspire, empower, and reward the tech leaders of tomorrow.
            </p>
            ...
            <div className="flex flex-wrap gap-16 py-6">
              ...
              <div className="space-y-1">
                <p className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">120+</p>
                <p className="text-gray-300">Projects Submitted</p>
              </div>
              
              <div className="space-y-1">
                <p className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">10+</p>
            ...
            {/* Bottom Description */}
            <p className="text-gray-300 text-lg max-w-xl">
              Step into the future of technology with cutting-edge challenges in programming, 
              design, data science, cybersecurity, and more. Compete, collaborate, and make 
              your mark in the tech community!
            </p>
          </div>
      ...
      <div className="bg-black text-white py-16 px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gray-300 mb-20 max-w-3xl mx-auto">
              Find quick answers to common questions about the event, including how to join, important dates, and general rules. For anything not listed here, feel free to contact us.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <p className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">01.</p>
                ...
                <div className="relative pl-16 pb-6">
                  <p className="text-gray-300">
                    University students, graduates, and tech enthusiasts across Indonesia are welcome. Check each category for specific rules.
                  </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <p className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">02.</p>
                  <h3 className="text-2xl font-bold">
                ...
                <div className="relative pl-16 pb-6">
                  <p className="text-gray-300">
                    To register, select your preferred competition, review the requirements, create an account, and complete the registration form.
                  </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <p className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">03.</p>
                  <h3 className="text-2xl font-bold">
                ...
                <div className="relative pl-16 pb-6">
                  <p className="text-gray-300">
                    Yes, the exact fee varies depending on the competition category and will be listed clearly on each competition page.
                  </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <p className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">04.</p>
                  <h3 className="text-2xl font-bold">
                    What do participants and winners receive from joining these competitions?
                  </h3>
                </div>
                <div className="relative pl-16 pb-6">
                  <p className="text-gray-300">
                    All participants will receive e-certificates, while winners can expect cash prizes, trophies, and recognition across our media platforms.
                  </p>
                  <div className="absolute bottom-0 left-16 right-0 h-1 bg-gradient-to-r from-purple-500 to-pink-500"></div>
                </div>
              </div>
